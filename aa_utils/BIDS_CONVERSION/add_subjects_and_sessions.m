...
function [ aap, SID_ADDED, SESS_ADDED ] = add_subjects_and_sessions(aap, datastamp_fname, SID_alias_fname, session_labels_fname)
                                                                                        

% generate aas_addsubject and aas_addsession calls 
%
% this version doesn't handle counterbalancing -- see add_subjects_and_sessions_CB
%
% USAGE
%
% [ aap, SID_ADDED, SESS_ADDED ] = add_subjects_and_sessions(aap, datastamp_fname, CB_fname, SID_alias_fname, session_labels_fname)
%
% INPUT:
%
...
%
%
%   2) SID_alias_fname - fullpath to plaintext comma-separated SID aliases. Example:
%
%       PL000103,sub-01
%       PL000105,sub-02
%       PL000110,sub-03
...
%
%   3) session_labels_fname -- fullpath to plaintext session labels. Ex:
%
%       SESS01
%       SESS02
%       SESS03
